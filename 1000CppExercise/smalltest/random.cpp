...
//		}
//
//		str[x] = t[randint(i - 1)];//trong truong hop khong co flag nao hop le no se random 1 trong 8 kieu ky tu
//	}
//
//	//null terminate the string
//	str[length] = 0;
...
//	std::cout << i << std::endl;
//
//	i = randint(0, RAND_MAX);
//	std::cout << i << "max integer: " << 0x7fff << std::endl;
//
//
//	float f = randfloat();
//	std::cout << "random a float: " << f << std::endl;
//
//	f = randfloat(29.8);
//	std::cout << "random a float: " << f << std::endl;
//	std::cout << 0x000000E0 << std::endl;
//	if (1)
//	{
//		i = 2 | 3;
//		std::cout << i << std::endl;
...
//	randstr(str, 9, RAND_STR_CAPITOL_LETTERS);
